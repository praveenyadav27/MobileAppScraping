...
def start_crawling(user_input=2500):
    try:
        if type(user_input) is int and int(user_input) >15000 and int(user_input) <2500:
            ...
            post_data_new = r'{"criteria":{"pageSize":'+ user_input +',"excludeIds":[],"initialCoordinates":{"lat":17.4673609,"long":78.3548533},"boundingBox":{}}}'
            ...
            raise Exception('Input is not a number or exceeded the limit')
    except Exception as e:
        print('Please check input or contact support!'+ ' Hint: ' + str(e) )
start_crawling(input("How many rows do you need? Please enter number."))
